...
if __name__ == "__main__":
    ...
    # Setup Results Directory & Add Logging Files
    os.makedirs("../Results_C", exist_ok=True)
    err_file = "../Results_C/monocular_reprojection_errors.txt"
    seeds_file = "../Results_C/monocular_seeds.txt"
    kf_file = "../Results_C/monocular_keyframes.txt"  # <--- ADDED KEYFRAME FILE
    ...
    with open("../Results_C/monocular_trajectory.txt", "w") as f:
        for line in trajectory_export: f.write(line + "\n")
    with open("../Results_C/monocular_stats.txt", "w") as f:
