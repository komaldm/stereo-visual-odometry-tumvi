...
if __name__ == "__main__":
    ...
    os.makedirs("../Results_mono", exist_ok=True)
    err_file = "../Results_mono/monocular_reprojection_errors.txt"
    seeds_file = "../Results_mono/monocular_seeds.txt"
    kf_file = "../Results_mono/monocular_keyframes.txt"  # <--- ADDED KEYFRAMES FILE
    ...
    with open("../Results_mono/monocular_trajectory.txt", "w") as f:
        for line in trajectory_export: f.write(line + "\n")
    with open("../Results_mono/monocular_stats.txt", "w") as f:
