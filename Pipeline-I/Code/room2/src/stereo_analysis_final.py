...
def find_ground_truth_file(results_dir):
    """Robustly hunts down the Ground Truth CSV using dynamic, relative paths."""
    ...
    dataset_gt_path = os.path.join(project_root, "dataset", "dataset-room2_512_16", "mav0", "mocap0", "data.csv")
    ...
    raise FileNotFoundError(
        ...
        f"Please ensure the dataset is extracted to 'dataset/dataset-room2_512_16/' or place 'gt_imu.csv' in the project root."
    )
...
if __name__ == "__main__":
    target_directory = "../Results_Room2_Dataset"
